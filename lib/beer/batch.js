...
const machineDate = require("../filters/machine-date.js");
const humanDate = require("../filters/human-date.js");
const shortDate = require("../filters/short-date.js");
...
class Batch {
  ...
  get machineBrewDate() {
    return machineDate(this.brewDate);
  }

  get prettyBrewDate() {
    return humanDate(this.brewDate);
  }

  get shortBrewDate() {
    return shortDate(this.brewDate);
  }
